...
Hooks.on("getSceneControlButtons", (buttons: any) => chex.manager._extendSceneControlButtons(buttons));
Hooks.on("updateScene", (document: any, change: any) => chex.manager._updateScene(document, change));
